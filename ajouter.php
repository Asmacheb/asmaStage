...
try {
    // Vérifier et ajouter les colonnes si elles n'existent pas dans la table Prix
    $columns = [
    ...
    // Initialiser les prix pour les burgers
    $burgers = [
    ...
    // Initialiser les prix pour les classiques
    $classiques = [
    ...
    // Initialiser les prix pour les compositions
    $compositions = [
