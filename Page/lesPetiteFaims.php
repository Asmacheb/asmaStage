...
<!-- NUGGETS -->
    ...
    <div class="backMozza" id="mozza">
        ...
        <div class="lesPrix">
            <div class="prix-container4">
            <div class="optionPetite">
                <span>3 STICK MOZZA</span>
                <p>6.50€</p>
            </div>
            <div class="optionPetite">
                <span>6 STICK MOZZA</span>
                <p>9€</p>
            </div>
            <div class="optionPetite">
                <span> STICK MOZZA</span>
                <p>9€</p>
            </div>
        </div>
        </div>
    ...
    <div class="backOignons" id="oignons">
        ...
        <div class="lesPrix">
            <div class="prix-container4">
            <div class="optionPetite">
                <span>4 OIGNONS RINGS</span>
                <p>6.50€</p>
            </div>
            <div class="optionPetite">
                <span>8 OIGNONS RINGS</span>
                <p>9€</p>
            </div>
            <div class="optionPetite">
                <span>10 OIGNONS RINGS</span>
                <p>9€</p>
            </div>
        </div>
        </div>
    ...
    <div class="backChili" id="chili">
        ...
        <div class="lesPrix">
            <div class="prix-container4">
            <div class="optionPetite">
                <span>3 CHILI CHEESE</span>
                <p>6.50€</p>
            </div>
            <div class="optionPetite">
                <span>6 CHILI CHEESE</span>
                <p>9€</p>
            </div>
            <div class="optionPetite">
                <span> CHILI CHEESE</span>
                <p>9€</p>
            </div>
        </div>
        </div>
