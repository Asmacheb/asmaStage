...
<!-- menu.php -->
    ...
    <div class="navbar">
        <div class="navLogo"><a href="Accueil.php#home"><img src="img/logosnack.png" alt="Logo"></a></div>
        ...
        <ul class="navMenu">
            <li class="submenu">
                <a href="lesBurgers.php" class="deroulant">BURGERS</a>
            ...
            <li class="submenu">
                ...
                <ul class="menuDeroulant">
                    ...
                    <li><a href="esClassiques.php#sandwich">Sandwich</a></li>
            ...
            <li class="submenu">
                ...
                <ul class="menuDeroulant">
                    ...
                    <li><a href="lesCompositions.php#tacos">Tacosbowl</a></li>
            ...
            <li class="submenu">
                ...
                <ul class="menuDeroulant">
                    <li><a href="lesPetiteFaims.php#nuggets">Nuggets</a></li>
                    <li><a href="lesPetiteFaims.php#mozza">Stick Mozza</a></li>
                    <li><a href="lesPetiteFaims.php#oignons">Oignons ring</a></li>
                    <li><a href="lesPetiteFaims.php#chili">Chili cheese</a></li>
                    <li><a href="lesPetiteFaims.php#salade">Salade</a></li>
                </ul>
            </li>
        </ul>
    </div>
